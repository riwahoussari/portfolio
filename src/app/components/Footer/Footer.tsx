...
export default function Footer() {
  ...
  const bottomRowY = useTransform(footerScroll, [0, 1], ["250%", "0%"]);
      ...
      <div className="relative h-[175vh] md:h-[150vh]">
        <div className="z-1 footer-y-padding sticky top-[100vh] flex h-[100vh] flex-col justify-between overflow-hidden">
          ...
          >
            {/* let's connect */}
            <h2
              className={`display-1 spaced opacity-20 max-sm:hidden ${localHover ? "md:opacity-5" : ""} duration-300 ease-in-out absolute select-none -z-1`}
            >
              RIWA <br />
              HOUSSARI
            </h2>
