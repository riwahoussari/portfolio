...
export default function ThemeButton(
  ...
  return (
    <button
      {...props}
      onMouseEnter={() => setIsHovering({ hover: "normal" })}
      onMouseLeave={() => setIsHovering({ hover: "none" })}
      onClick={() =>
    ...
    >
      <m.svg
        ...
        className="relative aspect-square w-full duration-300 ease-in-out group-hover:rotate-[-15deg]"
      >
        {/* sun rays */}
        <m.g
